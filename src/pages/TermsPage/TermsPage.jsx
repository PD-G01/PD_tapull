    ...
    <div className="terms-content">
            ...
            <section className="terms-section">
              ...
              <p>
                ...
                食PULLは、ユーザーが食料の提供とリクエストをマッチングし、チャットを通じてやり取りできるプラットフォームです。
            ...
            <section className="terms-section">
              ...
              <ul>
                ...
                <li>食料の提供において、賞味期限切れ、劣化、または不衛生な食品を提供する行為</li>
                <li>マッチングやチャット機能を利用して、詐欺や誤情報を広める行為</li>
                <li>位置情報を不正に利用する行為</li>
            ...
            <section className="terms-section">
              ...
              <p>
                特に、食料の提供・受領に関する品質、安全性、衛生面については、提供者と受領者の責任において行われるものであり、
                当サービスは一切の責任を負いません。ユーザーは自己の責任で食料の取り扱いを行ってください。
              </p>
            </section>
            ...
            <section className="terms-section">
              ...
              <p>
                ...
                位置情報やチャット履歴などのデータは、サービスの提供に必要な範囲で利用されます。
              </p>
            </section>
